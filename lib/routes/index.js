...
module.exports = function(app) {
  ...
  //If we wanted to use a realm level role we'd use 'realm:user' instead of 'user'
  ...
  //If we wanted to use a client level role we'd use 'supervisor' instead of 'realm:supervisor'
  route.get('/needs-supervisor-role', keycloak.protect('realm:supervisor'), function(req, res, next) {
  ...
  //If we wanted to use a realm level role, we'd use 'realm:admin' instead of 'admin'.
